...
public class BlicSearchResultPage extends BaseHelper
{
    WebDriver driver;
    public BlicSearchResultPage(WebDriver driver)
    {
        this.driver=driver;
    ...
    public String clickOnRequestedArticle(int numberOfElement)
    {
        ...
        WebElement article = articleList.get(0).findElement(By.tagName("h2"));
